...
<head>
   ...
   <meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <script defer src="https://cdnjs.cloudflare.com/ajax/libs/material-design-lite/1.1.3/material.min.js"></script>
</head>
                ...
                <table class="mdl-data-table  mdl-shadow--2dp">
                  ...
                  <tfoot>
                      ...
                      <tr class="grandtotals">
                          ...
                          <td class="mdl-color-text--deep-purple-A400"><strong><?php echo "\$".number_format($grand_total, 2)?></strong></td>
                      </tr>                            
                  </tfoot>
                </table>
            </div>
